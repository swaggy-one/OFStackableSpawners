package me.orbitium.ofstackablespawners;

import com.earth2me.essentials.Essentials;
import com.earth2me.essentials.Worth;
import me.orbitium.ofstackablespawners.commands.SSCommand;
import me.orbitium.ofstackablespawners.database.Cache;
import me.orbitium.ofstackablespawners.database.Database;
import me.orbitium.ofstackablespawners.listeners.BlockListener;
import me.orbitium.ofstackablespawners.listeners.InventoryListener;
import me.orbitium.ofstackablespawners.listeners.PlayerListener;
...
public final class OFStackableSpawners extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getCommand("stackableSpawners").setExecutor(command);
        getCommand("stackableSpawners").setTabCompleter(command);
    }
